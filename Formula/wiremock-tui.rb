class WiremockTui < Formula
  ...
  resource "prebuilt" do
    on_macos do
      on_arm do
        url "https://github.com/vplme/wiremock-tui/releases/download/v#{WiremockTui.version}/wiremock-tui-v#{WiremockTui.version}-aarch64-apple-darwin.tar.gz"
        sha256 "3ef49f3d58b52cf11a0e06eb33f29a9c647adf264fdc183bb3b30db92c064ce6"
      end
      on_intel do
        url "https://github.com/vplme/wiremock-tui/releases/download/v#{WiremockTui.version}/wiremock-tui-v#{WiremockTui.version}-x86_64-apple-darwin.tar.gz"
        sha256 "d0034479ce269dc9762d565d02e9eef909a91929344a0727e1842731d47c757d"
      end
    end
    on_linux do
      on_intel do
        url "https://github.com/vplme/wiremock-tui/releases/download/v#{WiremockTui.version}/wiremock-tui-v#{WiremockTui.version}-x86_64-unknown-linux-gnu.tar.gz"
